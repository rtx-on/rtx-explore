...
void DeviceResources::CreateWindowSizeDependentResources()
{
    ...
    UINT backBufferWidth = max(m_outputSize.right - m_outputSize.left, static_cast<long>(1));
    UINT backBufferHeight = max(m_outputSize.bottom - m_outputSize.top, static_cast<long>(1));
